...
public class EditingPostTest {
    public static void main(String[] args) {
        ...
        new WebDriverWait(driver,Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(inputTextPost));
        driver.findElement(By.xpath("//*[@id='content']//div[2]/textarea"))
